...
create schema petshop_auth
    ...
    create
        unique index petshop_auth_api_authentication_login_password_uindex
        on authentication (login, password);
...
-- auto-generated definition
    ...
    create
        unique index petshop_api_person_document_uindex
        on person (document)
    ...
    create
        unique index petshop_api_customer_email_uindex
        on customer (email)

    create
        unique index petshop_api_customer_fk_id_person_uindex
        on customer (fk_id_person)
    ...
    create
        unique index petshop_api_phone_fk_id_person_uindex
        on phone (fk_id_person)
    ...
    create
        unique index petshop_api_breed_fk_id_species_uindex
        on breed (fk_id_species)
...
--         FOREIGN KEY (fk_id_contract) references contract (id),
    ...
    create
        unique index petshop_api_schedule_number_uindex
        on schedule (number)

    create
        unique index petshop_api_schedule_fk_id_pet_uindex
        on schedule (fk_id_pet)

    create
        unique index petshop_api_schedule_fk_id_serv_employee_attention_time_uindex
        on schedule (fk_id_service_employee_attention_time);
